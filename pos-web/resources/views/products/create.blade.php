...
<div class="page-header">
    ...
    <p class="page-sub">Isi data produk di bawah ini. Stok awal akan otomatis dicatat sebagai mutasi masuk.</p>
</div>
        ...
        <div class="card-body">
            ...
            <div class="gc2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="sku" class="form-control" value="{{ old('sku') }}" placeholder="PRD-001" required>
                    <div class="form-hint">Kode unik / barcode produk</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="cost_price" class="form-control" value="{{ old('cost_price') }}" placeholder="0" min="0" step="100" required>
                    <div class="form-hint">Harga beli / modal dari supplier</div>
                </div>

                <div class="form-group">
                    <label class="form-label">Harga Jual (Rp) <span class="req">*</span></label>
                    <input type="number" name="selling_price" id="sellingPrice" class="form-control" value="{{ old('selling_price') }}" placeholder="0" min="0" step="100" required oninput="calcMargin()">
                </div>

                <div class="form-group">
                    <label class="form-label">Stok Awal <span class="req">*</span></label>
                    <input type="number" name="stock" class="form-control" value="{{ old('stock', 0) }}" min="0" required>
                    <div class="form-hint">Stok awal akan dicatat sebagai mutasi masuk</div>
                </div>
            </div>

            <div id="marginInfo" style="display:none;background:var(--success-light);border-radius:var(--radius-sm);padding:.75rem 1rem;font-size:.8125rem;color:#065F46;border:1px solid #A7F3D0">
...
function calcMargin(){
    ...
    if(sell>0&&sell>cost){
        ...
        const amt=new Intl.NumberFormat('id-ID').format(sell-cost);
